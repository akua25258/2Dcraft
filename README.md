...
Mojang,Microsoft,Minecraftとは一切関係ありません。<br>
...
e0.6.0.1:アイテムドロップのシステムを構築に失敗<br>
e0.6.0.1:アイテムドロップのシステムを構築に失敗<br>
...
v0.5.5.1:不明<br>
v0.6.0.0:アイテムドロップ要素を追加<br>
v0.6.0.1:アイテムドロップのシステムを構築<br>

# バグ　報告
・中度,再現可:破壊のクールタイムが0でキャンセル後、再度破壊をすると即時に破壊される。<br>
・重度,未発見:プレイヤーの当たり判定が正常でない。<br>
・軽度,再現可:セーブを使って再開するとインベントリーの値が正常でない。<br>
・<br>
・<br>
